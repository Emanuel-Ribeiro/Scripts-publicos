...
echo "criando usuarios e os adicionando aos grupos..."
...
useradd sebas  -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_VEN
useradd robert -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_VEN

useradd joseph -m -s /bin/bash -p $(openssl passwd -crypt Senha123) -G GRP_SEC
